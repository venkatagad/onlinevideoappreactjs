...
- Setup [Redux](https://github.com/reactjs/redux), [React Router](https://github.com/ReactTraining/react-router), [Redux Thunk](https://github.com/gaearon/redux-thunk) as `dependencies`.
- Setup [Redux Logger](https://github.com/evgenyrodionov/redux-logger), [Redux DevTools Dock Monitor](https://github.com/gaearon/redux-devtools-dock-monitor), [Redux DevTools Log Monitor](https://github.com/gaearon/redux-devtools-log-monitor) as `devDependencies`.
- Setup [Flow](https://flow.org) for Type Checking
- Code structure is as Rails-style as mentioned in [Redux docs](http://redux.js.org/docs/faq/CodeStructure.html)

That's it, nothing fancy.

### CRA Default readme file begins here:
